...
void main ()
{
  ...
  tmpvar_4.xyz = (tmpvar_8.xyz * _TreeInstanceScale.xyz);
  highp vec4 tmpvar_10;
...
void main ()
{
  ...
  enc_6.y = tmpvar_7.y;
  enc_6.x = (tmpvar_7.x - (tmpvar_7.y * 0.003921569));
  enc_5.zw = enc_6;
  tmpvar_1 = enc_5;
  gl_FragData[0] = tmpvar_1;
}
...
void main ()
{
  ...
  tmpvar_3.xyz = normalize((tmpvar_24 * _glesNormal));
...
void main ()
{
  ...
  tmpvar_1.xyz = normalize((tmpvar_18 * _glesNormal));

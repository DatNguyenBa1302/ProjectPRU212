...
void main()
{
    ...
    u_xlat4 = u_xlat0.y * hlslcc_mtx4x4glstate_matrix_modelview0[1].z;
    u_xlat0.x = hlslcc_mtx4x4glstate_matrix_modelview0[0].z * u_xlat0.x + u_xlat4;
    ...
    u_xlat1.xyz = u_xlat0.yyy * hlslcc_mtx4x4glstate_matrix_invtrans_modelview0[1].xyz;
    u_xlat0.xyw = hlslcc_mtx4x4glstate_matrix_invtrans_modelview0[0].xyz * u_xlat0.xxx + u_xlat1.xyz;
    u_xlat0.xyz = hlslcc_mtx4x4glstate_matrix_invtrans_modelview0[2].xyz * u_xlat0.zzz + u_xlat0.xyw;
...
void main()
{
    ...
    u_xlat1 = hlslcc_mtx4x4glstate_matrix_mvp[2] * u_xlat0.zzzz + u_xlat1;
    gl_Position = u_xlat1 + hlslcc_mtx4x4glstate_matrix_mvp[3];
    u_xlat1.x = u_xlat0.y * hlslcc_mtx4x4glstate_matrix_modelview0[1].z;
    u_xlat1.x = hlslcc_mtx4x4glstate_matrix_modelview0[0].z * u_xlat0.x + u_xlat1.x;
    u_xlat1.x = hlslcc_mtx4x4glstate_matrix_modelview0[2].z * u_xlat0.z + u_xlat1.x;
    ...
    u_xlat0.x = u_xlat1.x + hlslcc_mtx4x4glstate_matrix_modelview0[3].z;
    u_xlat0.x = u_xlat0.x * _ProjectionParams.w;
    vs_TEXCOORD1.w = (-u_xlat0.x);
...
void main()
{
    ...
    vs_TEXCOORD0.xy = in_TEXCOORD0.xy;
    u_xlat0.x = in_POSITION0.y * hlslcc_mtx4x4glstate_matrix_modelview0[1].z;
    u_xlat0.x = hlslcc_mtx4x4glstate_matrix_modelview0[0].z * u_xlat1.x + u_xlat0.x;
    u_xlat0.x = hlslcc_mtx4x4glstate_matrix_modelview0[2].z * u_xlat1.z + u_xlat0.x;
    u_xlat0.x = u_xlat0.x + hlslcc_mtx4x4glstate_matrix_modelview0[3].z;
    u_xlat0.x = u_xlat0.x * _ProjectionParams.w;
    vs_TEXCOORD1.w = (-u_xlat0.x);
    u_xlat0.xyz = in_NORMAL0.yyy * hlslcc_mtx4x4glstate_matrix_invtrans_modelview0[1].xyz;
